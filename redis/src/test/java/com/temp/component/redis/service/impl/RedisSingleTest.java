...
public class RedisSingleTest {
    Logger logger = LoggerFactory.getLogger(RedisSingleTest.class);
    @Autowired
...
//        cacheServiceJedisImpl.listGroupIdList();
    ...
    @Test
    public void redisCAS() {
        Jedis resource = jedisPool.getResource();
//        resource.hmset("ABC",new HashMap<String,String>(){{put("123","456");}});
//        Long abc = resource.msetnx("ABC", "11111","bbb","33333");
