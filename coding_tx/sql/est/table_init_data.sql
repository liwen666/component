/*
 ...
 Source Server         : 192.168.60.136
 Source Server Type    : MySQL
 Source Server Version : 50642
 Source Host           : 192.168.60.136:3306
 Source Schema         : anyest3_financial_cloud_15029

 Target Server Type    : MySQL
 Target Server Version : 50642
 File Encoding         : 65001

 Date: 20/08/2020 14:14:22
*/
...
-- ----------------------------
DROP TABLE IF EXISTS `table_code_relation`;
CREATE TABLE `table_code_relation`  (
  `id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `table_code_config`;
CREATE TABLE `table_code_config`  (
  `id` int(11) NOT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `used` bit(1) NULL DEFAULT NULL,
...
DROP TABLE IF EXISTS `table_conversion_key`;
CREATE TABLE `table_conversion_key`  (
  `id` int(11) NOT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `used` bit(1) NULL DEFAULT NULL,
...
DROP TABLE IF EXISTS `table_history_data`;
...
DROP TABLE IF EXISTS `table_import_sort`;
CREATE TABLE `table_import_sort`  (
  `id` int(11) NOT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `used` bit(1) NULL DEFAULT NULL,
...
DROP TABLE IF EXISTS `table_mark_init`;
CREATE TABLE `table_mark_init`  (
  `id` int(11) NOT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `used` bit(1) NULL DEFAULT NULL,
...
DROP TABLE IF EXISTS `table_param_config`;
CREATE TABLE `table_param_config`  (
  `id` int(11) NOT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `used` bit(1) NULL DEFAULT NULL,
...
alter table  meta_topic_object_info change feature_table_code data_table_name varchar(255);
...
update meta_data_object_info set data_source_id=(SELECT data_source_id FROM `meta_data_source_info` where source_name='系统初始化数据源') where data_source_id=1 or data_source_id is null;
