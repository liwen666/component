...
import com.temp.common.complier.test.demo3.DynamicClassLoad;
 ...
 */
public class HighCompile {
    public static void main(String[] args) throws IOException, NoSuchMethodException, ClassNotFoundException {
        String jarsStr = DynamicClassLoad.load(new String[]{"--dependency_external","D:\\workspace\\test_workspace\\coding_tx\\src\\main\\java\\com\\temp\\common\\complier\\high\\lib"});
        System.out.println(Class.forName("anycfs.common.util.ISO8601Utils"));
        ArrayList<File> objects = Lists.newArrayList();
        PackageScanUtils.findResourceByPath("D:\\workspace\\test_workspace\\coding_tx\\src\\main\\resources\\test\\GetSourceMetaFunction.java", objects);
