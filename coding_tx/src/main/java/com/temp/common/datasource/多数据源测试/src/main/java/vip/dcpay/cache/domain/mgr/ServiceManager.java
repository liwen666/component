package com.temp.common.datasource.多数据源测试.src.main.java.vip.dcpay.cache.domain.mgr;
...
public class ServiceManager {
    ...
    public void initTalble() {
        ...
        Statement stmt = null;
        try {
            Map<String, DataSource> beansOfType = SpringContextUtil.getBeansOfType(DataSource.class);
