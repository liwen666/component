...
public class UtilsGraphics2DLWLFinal {
...
//    private static String year = "2018年06月11日";
    ...
    public static void main(String[] args) throws Exception{
        ...
        try {
            String filePath = "D:\\idea2018workspace\\component_new\\coding_tx\\src\\main\\java\\com\\temp\\common\\base\\seal\\"+"编码"+".png";
...
//        drawMessage(messages,g,radius,CENTERX,CENTERY,fontSize);
    ...
    private static void drawMessageSeal(String[] messages , Graphics2D g,int radius, int CENTERX, int CENTERY,Integer fontsize){
        ...
        Rectangle2D bounds = f.getStringBounds(messatesEAL, context);
        ...
        //旋转角度
        double a = -2*Math.asin(char_interval/(2*radius2))*2;
