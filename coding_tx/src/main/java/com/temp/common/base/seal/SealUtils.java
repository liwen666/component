...
public class SealUtils {
    ...
    private static final String FONT_FAMILY = "仿宋"; // 字体
    //private static final String FOOT_TXT = "电子签约专用章";// 底部文字
    private static final String FOOT_TXT = "5205231014451";// 底部文字
    ...
    public static void main(String[] args) {
        try {
            String name = "我的印章2222";
            byte[] img = SealUtils.genSealData(name);
            byte2File(img, "D:\\idea2018workspace\\component_new\\coding_tx\\src\\main\\java\\com\\temp\\common\\base\\seal\\", name + ".png");
        } catch (IOException e) {
     ...
     * 125
     *
     * @param companyName 126
     * @return 127
     * @throws IOException 128
     */
