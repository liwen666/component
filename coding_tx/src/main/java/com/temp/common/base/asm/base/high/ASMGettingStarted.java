...
import com.temp.common.base.asm.base.MyClassLoader;
import com.temp.common.base.asm.base.TargetClass;
...
public class ASMGettingStarted
{
	...
	{
		String className = "com.temp.other.Test";
		/**
...
//		TargetClass targetClass  = (TargetClass) clazz.newInstance();
