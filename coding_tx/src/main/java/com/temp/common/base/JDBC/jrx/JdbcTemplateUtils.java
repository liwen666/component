...
public class JdbcTemplateUtils {
    ...
    // 1、Postgresql
    public static JdbcTemplate getJrxDb19()  {
...
//        dataSourceSSO.setUrl("jdbc:pivotal:greenplum://172.16.101.19:5432;DatabaseName=any_est_lw");
        ...
        dataSourceSSO.setUrl("jdbc:postgresql://172.16.101.19:5432/test_maxwell_data?reWriteBatchedInserts=true&nullCatalogMeansCurrent=true&currentSchema=public");
    ...
    // 1、Postgresql
    public static JdbcTemplate getJrxDb93()  {
        DruidDataSource dataSourceSSO = new DruidDataSource();
...
//        dataSourceSSO.setUrl("jdbc:pivotal:greenplum://172.16.101.19:5432;DatabaseName=any_est_lw");
    ...
    // 1、Postgresql
    public static JdbcTemplate getLocalMysqlGp()  {
        DruidDataSource dataSourceSSO = new DruidDataSource();

        //设置连接参数
        dataSourceSSO.setDriverClassName("com.mysql.jdbc.Driver");
        dataSourceSSO.setUrl("jdbc:mysql://192.168.42.136:3306/data_sync?serverTimezone=Hongkong&useUnicode=true&useSSL=false&characterEncoding=utf8");
        dataSourceSSO.setUsername("root");
        dataSourceSSO.setPassword("root");
        //配置初始化大小、最小、最大
        dataSourceSSO.setInitialSize(1);
    ...
    // 1、Postgresql
    public static JdbcTemplate getYanshiMsql()  {
        DruidDataSource dataSourceSSO = new DruidDataSource();

        //设置连接参数
        dataSourceSSO.setDriverClassName("com.mysql.jdbc.Driver");
        dataSourceSSO.setUrl("jdbc:mysql://10.0.2.15:3306/yanshi_data_sync?serverTimezone=Hongkong&useUnicode=true&useSSL=false&characterEncoding=utf8");
        dataSourceSSO.setUsername("any");
        dataSourceSSO.setPassword("any1234");
        //配置初始化大小、最小、最大
        dataSourceSSO.setInitialSize(1);
        dataSourceSSO.setMinIdle(1);
        dataSourceSSO.setMaxActive(20);
