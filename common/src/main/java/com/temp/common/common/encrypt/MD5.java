...
public final class MD5 {
	...
	public static void main(String[] args) {
		try {
			String md516 = MD5.MD5_16bit("fda代发ddd");
			System.out.println("16bit-md5:\n" + md516); //
			String md532 = MD5.MD5_32bit("fda代发ddd");
			String md5321 = MD5.MD5_32bit1("fda代发ddd");
			String md5322 = MD5.MD5_32bit2("fda代发ddd");
			...
			String md564 = MD5.MD5_64bit("fda代发ddd");
