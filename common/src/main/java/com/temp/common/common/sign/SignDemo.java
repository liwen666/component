...
public class SignDemo {
    ...
    public static KeyPair getKeypair() {
        ...
        try {
            ...
            System.out.println(JSON.toJSONString(myKeyGen));
    ...
    public static void main(String[] args) {
        try {
            ...
            byte[] publicinfo = getpublicByKeypair(mySig, keyPair, "验证我".getBytes());  //私钥加密
            System.out.println("=========================================================================================");
            System.out.println("私钥：  " + keyPair.getPrivate());
            System.out.println("公钥：  " + keyPair.getPublic());
            System.out.println("=========================================================================================");
            boolean verify = decryptBypublic(mySig, keyPair, "验证我", publicinfo);//公钥解密
